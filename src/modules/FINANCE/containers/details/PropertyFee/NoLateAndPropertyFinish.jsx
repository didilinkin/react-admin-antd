...
import {Row, Col, Icon, notification, Popconfirm} from 'antd'
...
class NoLateAndPropertyFinish extends React.Component {
    ...
    refresh = async () => {
        this.props.history.push('/home/financial/propertyFeeDetails/NoLateAndPropertyFinish/' + this.props.match.params.id)

...
// React component
class PlumbingInfrastructure extends Component {
    constructor (props) {
        super(props)
        this.state = {
            loading: false,
    ...
    async initialRemarks () {
        let result = await apiPost(
            'deviceMaintain/getPlumbingInfrastructure'
        )
    ...
    abnormal = async (id, type) => {
        ...
        if (resulData.data !== null) {
            window.location.href = '/deviceMaintain/electricalErrorDevice/' + id + ',12'
        } else {
            message.info('无异常信息')
        }
    }
...
export default PlumbingInfrastructure

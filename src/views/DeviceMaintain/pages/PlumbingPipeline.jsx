...
// React component
class PlumbingPipeline extends Component {
    constructor (props) {
        super(props)
        this.state = {
            loading: false,
    ...
    abnormal = async (id, type) => {
        ...
        if (resulData.data !== null) {
            location.href = '/deviceMaintain/electricalErrorDevice/' + id + ',11'
        } else {
            message.info('无异常信息')
        }
    }
...
export default PlumbingPipeline
